...
public class FirefightersModModEntities {
	public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, FirefightersModMod.MODID);
	public static final RegistryObject<EntityType<WaterEntity>> WATER = register("water",
