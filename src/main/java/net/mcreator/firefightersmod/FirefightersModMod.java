package net.mcreator.firefightersmod;
...
@Mod("firefighters_mod")
public class FirefightersModMod {
	public static final Logger LOGGER = LogManager.getLogger(FirefightersModMod.class);
	public static final String MODID = "firefighters_mod";

	public FirefightersModMod() {
