package net.mcreator.firefightersmod.client.renderer;
...
public class WaterRenderer extends EntityRenderer<WaterEntity> {
	private static final ResourceLocation texture = new ResourceLocation("firefighters_mod:textures/entities/missiled.png");
